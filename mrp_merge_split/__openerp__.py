...
* Splitting MO will be done from MO form view.for more detail you can refer following blog URL:
http://vperfectcs.com/blog/our-blogs-1/post/split-merge-manufacturing-orders-in-odoo-v8-0-10
    """,
    'author': 'VperfectCS',
